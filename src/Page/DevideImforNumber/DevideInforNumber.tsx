    ...
    <React.Fragment>
      ...
      >
        ...
        <div className='px-8 py-6 text-left bg-[#DADADA] w-[1280px] '>
          ...
          >
            <Col className='gutter-row mb-[27px]' span={8}>
              <div className='col-item'>Khám tim mạch</div>
            </Col>
            <Col className='gutter-row' span={8}>
              <div className='col-item'>Khám sản - Phụ khoa</div>
            </Col>
            <Col className='gutter-row' span={8}>
              <div className='col-item'>Khám tai mũi họng</div>
            </Col>
            <Col className='gutter-row' span={8}>
              <div className='col-item'>Khám răng hàm mặt</div>
            </Col>
            <Col className='gutter-row' span={8}>
              <div className='col-item'>Khám hô hấp</div>
            </Col>
            <Col className='gutter-row' span={8}>
              <div className='col-item'>Khám tổng quát</div>
            </Col>
          </Row>
        </div>
